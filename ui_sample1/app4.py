...
#rag_prompt - for all filetypes, updated Sh prompt
...
Compare the given files to knowledge Base Files, prioritize testcases for code changes and return STRICT structured output.
...
1. Compare function definitions by:
   - Function name
   - Parameters
   - Entire body content
 
2. If function name exists in both files but body differs → mark as modified.
 
3. If function exists only in new file → added.
 
4. If function exists only in old file → deleted.
