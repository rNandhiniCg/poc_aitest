#updated : api calls count , i/p o/p tokens
...
def get_priortized_testcases(modified_file):
    ...
    st.title("AI-Based Testcase Prioritization")
        ...
        if not new_files:
            ...
            with st.spinner("Thinking..."):
                ...
                if "content" in result:
                    ...
                    st.session_state.total_api_calls += api_calls
                    ...
                    try:
                        ...
                        st.text(answer)  # Display the raw answer for debugging
